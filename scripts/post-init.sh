...
_main() {
    ...
    echo -e "${LIGHTBLUE}┌[checking porcess kozmo-builder-backend]${NC}"
    echo "$(_check_process 'kozmo-builder-backend')"
    echo 

    echo -e "${LIGHTBLUE}┌[checking porcess kozmo-builder-backend-websocket]${NC}"
    echo "$(_check_process 'kozmo-builder-backend-websocket')"
    echo 

    echo -e "${LIGHTBLUE}┌[checking porcess kozmo-supervisor-backend]${NC}"
    echo "$(_check_process 'kozmo-supervisor-backend')"
    echo 

    echo -e "${LIGHTBLUE}┌[checking porcess kozmo-supervisor-backend-internal]${NC}"
    echo "$(_check_process 'kozmo-supervisor-backend-internal')"
    echo 
